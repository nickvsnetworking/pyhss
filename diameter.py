...
def Answer_257(packet_vars, avps):
    ...
    avp += generate_avp(260, 40, "000001024000000c010000160000010a4000000c000028af")            #Vendor-Specific-Application-ID (Gx)
    avp += generate_avp(260, 40, "000001024000000c01000023" + "000001024000000c01000016" + "0000010a4000000c000028af")            #Vendor-Specific-Application-ID (S6a)
